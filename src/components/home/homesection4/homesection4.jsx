          ...
          <div className="features">
            ...
            <div className="flex-container">
              ...
              <div className="feature-card">
                ...
                <p>
                  Committed to sustainability, we employ green coding practices
              ...
              <div className="feature-card">
                ...
                <p>
                  Accelerate your go-to-market with Virtue’s efficient
                  deployment strategies, reducing downtime and boosting
                  competitiveness.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p>
                  Our solutions integrate seamlessly with both legacy systems
                  and new technologies, enhancing flexibility across platforms.
                </p>
              </div>
            </div>
          </div>
